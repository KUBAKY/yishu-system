...
# Read original
with open('src/app/api/inference/route.ts', 'r', encoding='utf-8') as f:
    content = f.read()

# 1. Create src/lib/inference directory
os.makedirs('src/lib/inference', exist_ok=True)

# 2. Extract Types
types_ts = """export type InferencePayload = {
  paradigm?: string;
...
"""
with open('src/lib/inference/types.ts', 'w', encoding='utf-8') as f:
    f.write(types_ts)

# 3. Extract LLM Client
llm_client_ts = """import { OpenRouterResponse, OpenRouterChoice } from "./types";
...
"""
with open('src/lib/inference/llm-client.ts', 'w', encoding='utf-8') as f:
    f.write(llm_client_ts)


# 4. Extract Prompt Builder
prompt_builder_ts = """import { FoundationModule } from "@/types/inference";
...
"""
with open('src/lib/inference/prompt-builder.ts', 'w', encoding='utf-8') as f:
    f.write(prompt_builder_ts)

# 5. Extract Validator
validator_ts = """import { InferencePayload } from "./types";
...
"""
with open('src/lib/inference/validator.ts', 'w', encoding='utf-8') as f:
    f.write(validator_ts)

# 6. Rewrite src/app/api/inference/route.ts
route_ts = """import { NextRequest, NextResponse } from "next/server";
...
"""
with open('src/app/api/inference/route.ts', 'w', encoding='utf-8') as f:
    f.write(route_ts)
